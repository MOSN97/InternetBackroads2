...
var url = ["http://savbladet.dk/Index.htm", "https://neave.tv/", "http://www.windows93.net/", "https://www.spacejam.com/",
          ...
          "https://www.funkbrewing.com/elizabethtown/", "https://blacklivesmatters.carrd.co/", "http://isitfridayyet.net/",
          "https://aartdevos.dk/", "https://www.foxnews.com/", "https://itch.io/",
...
//Code for displaying <extensionDir>/images/myimage.png:
  ...
  var arrow = new Image();
  arrow.src = chrome.runtime.getURL("images/arrow" + (Math.floor(Math.random()*7)).toString() + ".png");
...
function check_position(event) {
  ...
  if (Math.sqrt(Math.pow((event.pageX - arrow_x), 2) + Math.pow((event.pageY - arrow_y), 2)) < 42) {
